...
local mason = require('vimpire.plugins.mason')
local fidget = require('vimpire.plugins.fidget')
local notify = require('vimpire.plugins.notify')
local illuminate = require('vimpire.plugins.illuminate')
...
util.initialize(mason)
util.initialize(notify)
util.initialize(fidget)
util.initialize(illuminate)
